 ...
 *
 * Disassembly of DSDT.aml, Tue Sep  3 22:57:24 2019
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00021420 (136224)
 *     Revision         0x02
 *     Checksum         0x78
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "SKL     "
...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "SKL     ", 0x00000000)
{
    ...
    Name (SS4, One)
    // One
    OperationRegion (GNVS, SystemMemory, 0x4FF20000, 0x072C)
    ...
    OperationRegion (MNVS, SystemMemory, 0x4FF32018, 0x1000)
    ...
    Scope (\_SB.PCI0.LPCB.EC)
    {
        ...
        {
            Fatal (0x01, 0x80010000, 0x000111E0)
        }
